...
<body class="index-page">
    ...
    <header id="header" class="header dark-background d-flex flex-column">
        ...
        <a href="index.html" class="logo d-flex align-items-center justify-content-center">
            ...
            <h1 class="sitename">Ishfaq Ahmad</h1>
        </a>
    ...
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                <h2>Ishfaq Ahmad khan</h2>
                <p>I am <span class="typed" data-typed-items="Developer, Freelancer">Developer</span><span class="typed-cursor typed-cursor--blink" aria-hidden="true"></span><span class="typed-cursor typed-cursor--blink" aria-hidden="true"></span></p>
        ...
        <section id="about" class="about section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>About Me</h2>
                <p>An energetic and focused individual who is eager to start his career with a dynamic organization and wants to contribute to the growth and development of the corresponding organization by utilizing the possessed knowledge, skills, and abilities to the utmost possible level.</p>
                ...
                <div class="row gy-4 justify-content-center">
                    ...
                    <div class="col-lg-8 content">
                        ...
                        <p class="fst-italic py-3">
                            A passionate and detail-oriented Laravel developer with a strong foundation in PHP, MySQL, and modern web technologies. Skilled in building dynamic, scalable, and secure web applications, integrating third-party APIs, and optimizing performance. Experienced in developing and managing modules like Product Management, Order Processing, Authentication, and Payment Gateway Integration. Adept at troubleshooting and debugging to ensure smooth application functionality. Eager to contribute technical expertise to a forward-thinking team.
                        </p>
                        <div class="row">
                            <div class="col-lg-6">
                                <ul>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>20th March 1995</span></li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.example.com</span></li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+92 315 9068867</span></li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Mardan KPK, Pakstan</span></li>
                                </ul>
                            </div>
                            <div class="col-lg-6">
                                <ul>
                                    ...
                                    <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>Ishfaq9701@gmail.com</span></li>
        ...
        <section id="skills" class="skills section light-background">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Skills</h2>
                <p>A highly skilled and adaptable developer with expertise in web development and data technologies.</p>
            </div><!-- End Section Title -->
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row skills-content skills-animation">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="progress">
                            <span class="skill"><span>M.S Office Suite</span> <i class="val">87%</i></span>
                            <div class="progress-bar-wrap">
